...
class SchoolTestCase(BaseTestCase):
    ...
    def test_secretary_correct_creation(self):
        """
        Test the creation of a secretary, using the correct admin and school.
        :return:
        """
        form_data = {
            'first_name': 'Paolino',
        ...
        tf = SecretaryForm(user=self.a1, data=form_data)
        tf.full_clean()
        self.assertTrue(tf.is_valid())

    def test_secretary_wrong_admin_for_school_creation(self):
        """
        Test the creation of a secretary, using the wrong school for the admin.
        :return:
        """
        form_data = {
            'first_name': 'Paolino',
